...
import { Home, Users, Building, PieChart, FileText, Settings, LogOut, Shield, LayoutGrid } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { icon: LayoutGrid, label: 'Client Panel', href: '/clients', module: 'clients' as AccessModule },
